...
public class Grafico_Temperatura {
   static SerialPort chosenPort;
    static int x=0;
    
    public static void main(String[] args) {
        JFrame window =new JFrame();
        window.setTitle("Temperatura");
	...
	window.add(topPanel, BorderLayout.NORTH);
        ...
        JFreeChart chart = ChartFactory.createXYLineChart("Temperatura rilevata", "Tempo (s)", "Temperatura (°C)", dataset);
